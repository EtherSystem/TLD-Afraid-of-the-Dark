[assembly: MelonInfo(typeof(AnxietyAtNight.Core), "AnxietyAtNight", "2.0.1", "EtherSystem", null)]
...
namespace AnxietyAtNight
{
    public class Core : MelonMod
    {
        ...
        internal class Anxiety_Update
        {
            ...
            {
                return (GameManager.GetPlayerManagerComponent().m_ItemInHands
                    && GameManager.GetPlayerManagerComponent().m_ItemInHands.m_TorchItem
                    && GameManager.GetPlayerManagerComponent().m_ItemInHands.m_TorchItem.IsBurning());
            }
